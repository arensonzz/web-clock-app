...
btnIncreaseHours.addEventListener('click', () => {
  if (+displayHours.innerText < 99) {
    displayHours.innerText = String(+displayHours.innerText + 1).padStart(
      2,
      '0'
    );
  } else {
...
btnIncreaseMinutes.addEventListener('click', () => {
  if (+displayMinutes.innerText < 59) {
    displayMinutes.innerText = String(+displayMinutes.innerText + 1).padStart(
      2,
      '0'
    );
  } else {
...
btnIncreaseSeconds.addEventListener('click', () => {
  if (+displaySeconds.innerText < 59) {
    displaySeconds.innerText = String(+displaySeconds.innerText + 1).padStart(
      2,
      '0'
    );
  } else {
...
displayHours.addEventListener('click', () => {
  displayHours.innerText = normalizeClockNumber(
    prompt('Enter hours for timer:'),
    0,
    99
  );
});
